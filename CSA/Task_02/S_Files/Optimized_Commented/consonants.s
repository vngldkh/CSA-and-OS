...
is_consonant:
	...
	.p2align 3
.L9:
	# i хранится в регистре ax, а не на стеке DWORD PTR -68[rbp]
	cmp	rax, rcx
	je	.L6
	# В dx хранится текущий символ
	movzx	edx, BYTE PTR [rax]
	add	rax, 1
.L3:
	# Проверяемый символ продолжает храниться в dx, а не записывается на стек
	cmp	dil, dl
	jne	.L9
	mov	eax, 1
.L1:
...
.L16:
	...
	.p2align 3
.L21:
	# i хранится не на стеке (DWORD PTR -68[rbp]), а в ax
	cmp	rsi, rax
	je	.L14
	movzx	edx, BYTE PTR [rax]
	add	rax, 1
